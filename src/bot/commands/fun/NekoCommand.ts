...
export default class NekoCommand extends NekosLifeAPICommand {
    ...
    public get helpInfo(): HelpInfo {
        return {
            "description": "Sends a neko into the chat",
            "usages": [
                {
                    "info": "Sends a neko in the chat",
                    "parameters": []
                }
            ],
            "examples": [
                {
                    "info": "Sends an embed of a neko into the current chat",
                    "raw_message": ""
                }
            ]
        };
